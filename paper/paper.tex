...
perplexity \emph{improves} (up to $-4.1\%$ small, $-0.9\%$ medium). Our study differs
...
expert-locality decode routing \citep{eldr2026} exploits locality at serving time. Our contribution relative
...
\citealp{fang2025fate}), and related systems predict, prefetch, cache, or
...
and data hashes are released at \url{https://github.com/Shriniwas410/sticky-moe}.
...
from these. Code and artifacts: \url{https://github.com/Shriniwas410/sticky-moe}.
